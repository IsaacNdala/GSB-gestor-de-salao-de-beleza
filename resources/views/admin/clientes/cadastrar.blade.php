            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title"><i class="fa fa-plus-circle"></i> Cadastrar Clientes</strong>
                    </div>
                    <div class="card-body">
                        <!-- Formulário de Cadastro de Funcionario --> 
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form action="/admin/clientes/create" method="POST" enctype="multipart/form-data">
                                    @csrf
