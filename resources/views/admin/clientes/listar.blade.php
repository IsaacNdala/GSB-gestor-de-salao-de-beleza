    ...
    <div class="animated fadeIn">
        ...
        <div class="row mb-3">
            <div class="col-12 d-flex justify-content-end">
                <a href={{ route('clientes.cadastrar') }} class="btn btn-info mr-3"><i class="fa fa-plus"></i> Cadastrar</a>
                            ...
                            <tbody>
                                @if (count($clientes) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href={{ route('clientes.editar', ['id' => $cliente->id]) }} class="btn btn-dark"><i class="fa fa-edit"></i></a></td>
                                            ...
                                            <div class="modal-dialog modal-md" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            Deseja deletar "{{ $cliente->user->nome  }}"?
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                        <form action="/admin/clientes/deletar" method="POST">
                                                            @csrf
                                                            <input type="text" name="user_id" value={{ $cliente->user_id }} hidden>
