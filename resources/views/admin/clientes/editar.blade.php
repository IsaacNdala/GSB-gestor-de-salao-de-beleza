            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title"><i class="fa fa-plus-circle"></i> Editar Clientes</strong>
                    </div>
                    <div class="card-body">
                                ...
                                <form action="/admin/clientes/edit" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input 
                                            ...
                                            required
                                            value='{{ old('nome', $cliente->user->nome) }}'>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="tel" name="tel" placeholder="Telefone" class="form-control" required value={{ old('tel', $cliente->user->tel) }}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input 
                                            ...
                                            required value={{ old('morada', $cliente->user->morada) }}>
                                    </div>
