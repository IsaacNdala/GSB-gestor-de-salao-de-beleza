                        ...
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span class="count">200.000</span>kz</div>
                                    <div class="stat-heading">Receita</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span class="count">{{ count($agendas) }}</span></div>
                                    <div class="stat-heading">Agendados</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span class="count">{{ count($servicos) }}</span></div>
                                    <div class="stat-heading">Servicos</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span class="count">{{ count($clientes) }}</span></div>
                        ...
                        <div class="col-lg-4">
                            <div class="card-body">
                                ...
                                <div class="progress-box progress-2">
                                    ...
                                    <div class="por-txt">6 Users (24%)</div>
                                    <div class="progress mb-2" style="height: 5px;">
                                ...
                                <div class="progress-box progress-2">
                                    <h4 class="por-title">Outros</h4>
                                    <div class="por-txt">20 (60%)</div>
                                    <div class="progress mb-2" style="height: 5px;">
                                ...
                                <div class="progress-box progress-2">
                                    <h4 class="por-title">Recomendados</h4>
                                    <div class="por-txt">4 (30%)</div>
                                    <div class="progress mb-2" style="height: 5px;">
